...
1. Save a csv named "computers.csv" to the same directory. Include the following headers: "client,computer_name,build" and populate the csv with the corresponding data.
